...
%         kztmp=yy(it,6)+dFdz1/dFdw1*dt;
        ...
        %%%SZH修改-START
        rtmp=yy(it,1)-dFdkr1/dFdw1*dt/2;%%%!!!这里修了RK4的系数！
        phitmp=yy(it,2)-dFdnphi1/dFdw1*dt/2;
        ztmp=yy(it,3)-dFdkz1/dFdw1*dt/2;
        krtmp=yy(it,4)+dFdr1/dFdw1*dt/2;
        nphitmp=yy(it,5)+dFdphi1/dFdw1*dt/2;
        kztmp=yy(it,6)+dFdz1/dFdw1*dt/2;
        %加上一阶的计算结果
        %%%SZH修改-END
...
%         kztmp=yy(it,6)+dFdz2/dFdw2*dt;
        ...
        %%%SZH修改-START
        rtmp=yy(it,1)-dFdkr2/dFdw2*dt/2;
        phitmp=yy(it,2)-dFdnphi2/dFdw2*dt/2;
        ztmp=yy(it,3)-dFdkz2/dFdw2*dt/2;
        krtmp=yy(it,4)+dFdr2/dFdw2*dt/2;
        nphitmp=yy(it,5)+dFdphi2/dFdw2*dt/2;
        kztmp=yy(it,6)+dFdz2/dFdw2*dt/2;
        %%%SZH修改-END
