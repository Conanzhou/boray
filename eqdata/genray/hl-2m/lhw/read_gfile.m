...
elseif(indexrho==5)    
    rhorz0=(psi-Psi_axis)./(Psi_bound1-Psi_axis);
end
...
rg=R; zg=Z;
rr=RR2.'; zz=ZZ2.';
% fBr=Br; fBz=Bz;   % 21-05-17 08:47 C-mod case
...
% [aa,cc]=ndgrid(eqdsk_r,eqdsk_z);figure;contour(aa,cc,eqdsk_psi);