...
syms x y
<<<<<<< HEAD
sol = solve(y>0.01,x==facter1(1)*y^3+facter1(2)*y^2+facter1(3)*y^1+facter1(4),x==facter0(1)*y^6+facter0(2)*y^5+facter0(3)*y^4+facter0(4)*y^3+facter0(5)*y^2+facter0(6)*y^1+facter0(7));
cross1_x = double(sol.x);
cross1_y = double(sol.y);
%
sol = solve(y>0.01,x==facter2(1)*y^3+facter2(2)*y^2+facter2(3)*y^1+facter2(4),x==facter0(1)*y^6+facter0(2)*y^5+facter0(3)*y^4+facter0(4)*y^3+facter0(5)*y^2+facter0(6)*y^1+facter0(7));
cross2_x = double(sol.x);
cross2_y = double(sol.y);
%
sol = solve(y>0.01,x==facter3(1)*y^3+facter3(2)*y^2+facter3(3)*y^1+facter3(4),x==facter0(1)*y^6+facter0(2)*y^5+facter0(3)*y^4+facter0(4)*y^3+facter0(5)*y^2+facter0(6)*y^1+facter0(7));
=======
...
<<<<<<< HEAD
x1_num = find(abs(x1y-cross1_y)<=1e-6);
=======
...
%
<<<<<<< HEAD
o2_num = find(abs(o2y-cross2_y)<=5e-6);
=======
o2_num = find(abs(o2y-cross2_y)<=2e-6);
>>>>>>> a30d29f843cedd73c6d138c59f0c3b26dd90506b
x2_num = find(abs(x1y-cross2_y)<=1e-6);
...
%
<<<<<<< HEAD
o3_num = find(abs(o3y-cross3_y)<=5e-6);
x3_num = find(abs(x1y-cross3_y)<=1e-6);
=======
